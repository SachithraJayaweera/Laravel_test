...
<div class="container">
    ...
    <div style="display: flex; flex-direction: column; margin-right: 75%">
        ...
        <a href="{{ route('definefreeissues') }}" class="btn btn-primary" style="background-color: green; border: none; margin-top:20px; padding:15px">Define free Issue</a> 
        <a href="{{ route('defineDiscounts') }}" class="btn btn-primary" style="background-color: green; border: none; margin-top:20px; padding:15px">Define Discounts</a> 
        <a href="{{ route('placingorder') }}" class="btn btn-primary" style="background-color: green; border: none; margin-top:20px; padding:15px">Placing Order</a> 
    </div>
